...
' LANGUAGE 'plpgsql';
--
-- PostgreSQL 8.3 does not have pg_stat_replication.
--

--
-- PostgreSQL 8.3 does not have pg_stat_database_conflicts.
--

--
-- PostgreSQL 8.3 does not have pg_stat_statements.
--
